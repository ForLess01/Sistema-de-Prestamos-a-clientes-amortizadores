...
#include "uProLis4.h" // parala clase cListPrePen
...
int cProLis::Menu()
{
    const char *opciones[] = { "Prestamos por Cliente ",
                        "Prestamos Otorgados",
    ...
    CentraCad(7, "C O N S U L T AS");

    voOpcion = MenuPopUp(30,10,opciones, 7);
    if (voOpcion == 7)
        voOpcion = 0;
    return voOpcion;
}
